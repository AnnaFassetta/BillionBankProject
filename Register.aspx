<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="BillionBankProject.Register" %>
...
<body>
    <form id="form1" runat="server">
        <h1 style="height: 34px; width: 599px; background-color: #FF99FF">Register</h1>
        <br />
        <img class="auto-style1" src="ImagesIMG/istockphoto-1146311489-612x612.jpg" /><br />
        <br />
